...
(function() {
	...
	praetorian.prototype.requirements = function( schema, callback ) {
		...
		try {
			...
			var addRequirement = function( example, field ) {
				var requirementExample = options.messages.NO_EXAMPLE_GIVEN;
				// returns the field "requirement" details in a consistent schema				
				if( example ) {
					requirementExample = example;
				} else if( options.messages['EXAMPLE_MUST_BE_' + field.type.toUpperCase()] ) {
