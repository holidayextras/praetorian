		...
		var parseJson = function( json, schema, schemaType, elementPrefix ) {
			...
			_.each( json, function( levelValue, levelKey ) {
				...
				if( _.isUndefined( schema[levelKey] ) ) {
					...
					if( !_.isUndefined( schema[levelKey].type ) ) {
						switch( schema[levelKey].type ) {
							case 'boolean':
								json[levelKey] = !!levelValue;
								break;
							case 'integer':
								json[levelKey] = parseInt( levelValue );
								break;
							case 'decimal':
								json[levelKey] = parseFloat( levelValue );
								break;
							default:
								break;
						}
